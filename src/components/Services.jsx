  ...
  return (
    <section id="services" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        >
          <h4 className="text-blue-600 font-semibold text-lg mb-4">Our Expertise</h4>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            >
              <div className={`bg-gradient-to-br ${feature.bgColor} rounded-2xl p-8 text-white h-full transform group-hover:scale-105 transition-transform duration-300`}>
