      ...
      <div className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              <div className="mb-6">
                <div className="w-48 h-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg flex items-center justify-center mb-4">
                  <span className="text-white font-bold text-lg">Vedhanthi Technologies</span>
                </div>
      ...
      <div className="border-t border-gray-800 py-8">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            >
              © {currentYear} <a href="#home" className="text-blue-400 hover:text-blue-300 transition-colors duration-200">Vedhanthi Technologies.</a> All Rights Reserved
            </motion.div>
